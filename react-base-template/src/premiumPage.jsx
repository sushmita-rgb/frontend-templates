...
">
  Most Popular
                    ...
                    <div className="flex justify-between">
                        <h2 className="text-3xl text-[var(--text-dark)] font-bold">{tiername}</h2>
                        <span className="text-xl text-[var(--primary-dark)]">&#8377;{pricing}/{pricingper}</span>
                    </div>
                    <ul className="mt-6 flex flex-col gap-2 text-xs">
                        ...
                        {notperks.map(perk => (
                            ...
                            <li className="opacity-50">
                                ...
                                <span className="line-through text-[var(--primary-dark)]/60">{perk}</span>
                            </li>
                        ))
                        }
