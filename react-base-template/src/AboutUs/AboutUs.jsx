...
function Card({ name, profilePicture, role, socialIcon = {} }) {
  return (
    <>
      <div
        className="flex flex-col items-center justify-center w-auto p-4 rounded-md bg-[#ecfdf5]
...
hover:shadow-[0_0_2px_rgba(22,163,74,0.5)]"
  ...
  "
        ...
        <span className="text-xs font-mono pb-3 font-medium text-[#15803d]">
          {role}
        </span>
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-6 w-full bg-base-200">
        <span className="text-center text-5xl text-[#064e3b]">
        ...
        <div className="lg:flex-row flex-col justify-around">
          <p className="text-sm text-black">
            ...
            consequuntur, dolores est fugiat illo impedit incidunt ipsum
            laudantium minus molestiae nesciunt nisi omnis perferendis quas
            quibusdam, quos tenetur vero vitae voluptates! Accusantium amet,
            assumenda consectetur culpa facere ipsum minus.
          </p>
        </div>
        <span className="text-center text-5xl text-[#064e3b]">
          About the <span className="text-[#15803d]">Team</span>
        </span>
          ...
          {[
            {
              ...
              profilePicture:
                "https://avatars.githubusercontent.com/u/237316139",
              socialIcon: {
            ...
            },
            {
              ...
              role: "Frontend Developer",
              profilePicture:
                "https://avatars.githubusercontent.com/u/193432954?v=4",
              socialIcon: {
                github: "https://github.com/sushmita-rgb",
                linkedin:
                  "https://www.linkedin.com/in/sushmita-singh-003011319/",
              },
            },
          ].map((obj) => (
            <Card
